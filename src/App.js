...
import AddClients from "./components/settings/clients/clientForm";
import editClients from "./components/settings/clients/clientForm";
import viewClient from "./components/settings/clients/viewClient";

import Regions from "./components/settings/region/index";
import addRegion from "./components/settings/region/regionForm";
import editRegion from "./components/settings/region/regionForm";
import viewRegion from "./components/settings/region/viewRegion";

import Sites from "./components/settings/sites/index";
import addSite from "./components/settings/sites/siteForm";
import editSite from "./components/settings/sites/siteForm";
...
import addBinder from "./components/settings/binder/binderForm";
import editBinder from "./components/settings/binder/binderForm";
    ...
    return (
        <Router history={history}>
            <Switch>
                ...
                <PrivateRoute exact path="/addClient" component={AddClients} />
                <PrivateRoute exact path="/editClient" component={editClients} />
