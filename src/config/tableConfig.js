...
export const activityTableData = {
    ...
    config: {
        ...
        binder: {
            ...
            label: "Binder",
            class: "",
            searchKey: "binders.name",
            type: "object",
            hasWildCardSearch: true,
            hasCommonSearch: false,
            getListTable: "binders",
            commonSearchKey: "binders",
            commonSearchObjectKey: "name"
        },
        client: {
            isVisible: true,
        ...
        reference: {
            ...
            label: "Reference",
            class: "",
            searchKey: "activities.reference",
            type: "string",
            hasWildCardSearch: true,
            hasCommonSearch: false,
            getListTable: "regions",
...
export const binderTableData = {
    keys: ["code", "name", "display_name", "consultancy", "client", "color", "text_color", "line", "order", "created_at", "updated_at"],
    config: {
        code: {
            isVisible: true,
            label: "Binder Code",
            class: "",
            searchKey: "binders.code",
            type: "string",
            hasWildCardSearch: true,
            hasCommonSearch: false,
            getListTable: "binders",
        ...
        display_name: {
            ...
            label: "Display Name",
            class: "reg-name",
            searchKey: "binders.display_name",
            type: "string",
            hasWildCardSearch: true,
            hasCommonSearch: false,
            getListTable: "binders",
