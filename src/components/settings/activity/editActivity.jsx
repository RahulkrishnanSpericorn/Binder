                        ...
                        <div className="pub-ara six">
                            <div className="frm-ara three-col">
                                        ...
                                        <div className="itm-cnt">
                                            <div className="form-group select-group">
                                                ...
                                                <select
                                                    ...
                                                    onChange={e => {
                                                        this.setState({ client_id: e.target.value, clientErrorMsg: false });
                                                    }}
                                                >
                                                    <option value="">Select</option>
                                        ...
                                        <div className="itm-cnt">
                                            <div className="form-group">
                                                ...
                                                <input
                                                    ...
                                                    onChange={e => {
                                                        this.setState({ text_color: e.target.value });
                                                    }}
                                                    className="form-control"
                                ...
                                <div className="frm btn-sec">
                                    <button onClick={() => this.editBinder()} className="btn btn-submit">
                                        {" "}
