...
class editBuilding extends Component {
    ...
    editBuilding = async() => {
        ...
        if(this.state.name != '' && this.state.consultancy_id != '' && this.state.client_id != '' && this.state.region_id != '' && this.state.site_id != ''){
            ...
            if (this.props.buildingReducer.editBuildingData.message === "Building updated successfully") {
                    ...
                    <div className="pub-ara six">
                        <div className="frm-ara">
                                ...
                                <div className="itm">
                                    ...
                                    <div className="itm-cnt">
                                        <div className="form-group">
                                            <label className="form-control-placeholder" style={{color:this.state.nameErrorMsg ?"red" :null}} for="f-name">Building Name</label>
                                            <input type="text" id="text" value={this.state.name} onChange={(e) => { this.setState({ name: e.target.value,nameErrorMsg:false }) }} className="form-control" placeholder="Enter Building Name " />
                                        </div>
                                    </div>
                                </div>
                                <div className="itm">
                                ...
                                <div className="itm">
                                    ...
                                    <div className="itm-cnt">
                                        <div className="form-group select-group">
                                            ...
                                            <select className="form-control select" value={this.state.client_id} onChange={(e) => { this.selectClientId(e) }}>
                                                <option value="">Select</option>
                                                {
                                ...
                                <div className="itm">
                                    ...
                                    <div className="itm-cnt">
                                        <div className="form-group select-group">
                                            ...
                                            <select className="form-control select" value={this.state.region_id} onChange={(e) => { this.selectRegionId(e) }}>
                                                <option value="">Select</option>
                                                {
                                ...
                                <div className="itm">
                                    ...
                                    <div className="itm-cnt">
                                        <div className="form-group select-group">
                                            ...
                                            <label className="form-control-placeholder" style={{ color: this.state.siteErrorMsg && 'red' }} for="f-name">Site *</label>
                                            <select className="form-control select" value={this.state.site_id} onChange={(e) => { this.setState({ site_id: e.target.value,siteErrorMsg:false }) }}>
                                                <option value="">Select</option>
                                                {
                                                    this.state.siteIdList.length && this.state.siteIdList.map((item, idex) => {
                                                        return (
                                                            <option value={item.id}> {item.name} </option>
                                                        )
                                                    })
                                ...
                                <div className="itm">
                                    ...
                                    <div className="itm-cnt">
                                        <div className="form-group">
                                            ...
                                            <input type="text" id="text" value={this.state.display_name} onChange={(e) => { this.setState({ display_name: e.target.value }) }} className="form-control" placeholder="Enter Display Name " list="builiding" name="builiding" />
                                ...
                                <div className="itm">
                                    ...
                                    <div className="itm-cnt">
                                        <div className="form-group">
                                            ...
                                            <input type="text" id="text" value={this.state.description} onChange={(e) => { this.setState({ description: e.target.value }) }} className="form-control" placeholder="Enter Description " />
                                        </div>
                                    </div>
                                </div>
                                <div className="itm">
                                    ...
                                    <div className="itm-cnt">
                                        <div className="form-group">
                                            ...
                                            <input type="number" id="text" value={this.state.number} onChange={(e) => { this.setState({ number: e.target.value }) }} className="form-control" placeholder="Enter Building Number" list="buildigNumber" name="buildigNumber" />
                                            {/* <span className="material-icons">keyboard_arrow_down </span> */}
                                ...
                                <div className="itm">
                                    ...
                                    <div className="itm-cnt">
                                        <div className="form-group">
                                            ...
                                            <input type="text" id="text" className="form-control" placeholder="Enter Consultancy Users " list="cosultancy" name="cosultancy" />
                                            <span className="material-icons">keyboard_arrow_down </span>
                                ...
                                <div className="itm">
                                    ...
                                    <div className="itm-cnt">
                                        <div className="form-group">
                                            ...
                                            <input type="text" id="text" className="form-control" placeholder="Enter Client Users " list="client-u" name="client-u" />
                                            <span className="material-icons">keyboard_arrow_down </span>
                                ...
                                <div className="itm">
                                    ...
                                    <div className="itm-cnt">
                                        <div className="form-group">
                                            ...
                                            <input type="number" id="text" value={this.state.area} onChange={(e) => { this.setState({ area: e.target.value }) }} className="form-control" placeholder="Enter Area (Sq) " />
                                        </div>
                                    </div>
                                </div>
                                <div className="itm">
                                    ...
                                    <div className="itm-cnt">
                                        <div className="form-group">
                                            ...
                                            <input type="number" id="text" value={this.state.cost} onChange={(e) => { this.setState({ cost: e.target.value }) }} className="form-control" placeholder="Enter Cost " />
                                        </div>
                                    </div>
                                </div>
                                <div className="itm">
                                    ...
                                    <div className="itm-cnt">
                                        <div className="form-group">
                                            ...
                                            <input type="text" id="text" value={this.state.enterprise_index} onChange={(e) => { this.setState({ enterprise_index: e.target.value }) }} className="form-control" placeholder="Enter Enterprice Index " />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="itm">
                                    ...
                                    <div className="itm-cnt">
                                        <div className="form-group">
                                            ...
                                            <input type="text" id="text" value={this.state.ownership} onChange={(e) => { this.setState({ ownership: e.target.value }) }} className="form-control" placeholder="Enter Ownership " />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="itm">
                                    ...
                                    <div className="itm-cnt">
                                        <div className="form-group">
                                            ...
                                            <input type="text" id="text" value={this.state.ownership_type} onChange={(e) => { this.setState({ ownership_type: e.target.value }) }} className="form-control" placeholder="Enter Ownership Type" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="itm">
                                    ...
                                    <div className="itm-cnt">
                                        <div className="form-group">
                                            ...
                                            <input type="text" id="text" value={this.state.use} onChange={(e) => { this.setState({ use: e.target.value }) }} className="form-control" placeholder="Enter Use " />
                                        </div>
                                    </div>
                                </div>
                                <div className="itm">
                                    ...
                                    <div className="itm-cnt">
                                        <div className="form-group">
                                            ...
                                            <input type="text" id="text" value={this.state.manager} onChange={(e) => { this.setState({ manager: e.target.value }) }} className="form-control" placeholder="Enter Manager " />
                                        </div>
                                    </div>
                                </div>
                                <div className="itm">
                                    ...
                                    <div className="itm-cnt">
                                        <div className="form-group">
                                            ...
                                            <input type="number" id="text" value={this.state.year} onChange={(e) => { this.setState({ year: e.target.value }) }} className="form-control" placeholder="Enter Year Built " />
                                        </div>
                                    </div>
                                </div>
                                <div className="itm">
                                    ...
                                    <div className="itm-cnt">
                                        <div className="form-group">
                                            ...
                                            <input type="text" id="text" value={this.state.ministry} onChange={(e) => { this.setState({ ministry: e.target.value }) }} className="form-control" placeholder="Enter Ministry " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="itm">
                                    ...
                                    <div className="itm-cnt">
                                        <div className="form-group">
                                            ...
                                            <input type="text" id="text" value={this.state.street} onChange={(e) => { this.setState({ street: e.target.value }) }} className="form-control" placeholder="Enter Street " />
                                        </div>
                                    </div>
                                </div>
                                <div className="itm">
                                    ...
                                    <div className="itm-cnt">
                                        <div className="form-group">
                                            ...
                                            <input type="text" id="text" value={this.state.city} onChange={(e) => { this.setState({ city: e.target.value }) }} className="form-control" placeholder="Enter City " />
                                        </div>
                                    </div>
                                </div>
                                <div className="itm">
                                    ...
                                    <div className="itm-cnt">
                                        <div className="form-group">
                                            ...
                                            <input type="text" id="text" value={this.state.state} onChange={(e) => { this.setState({ state: e.target.value }) }} className="form-control" placeholder="Enter State " />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="itm">
                                    ...
                                    <div className="itm-cnt">
                                        <div className="form-group">
                                            ...
                                            <input type="text" id="text" value={this.state.country} onChange={(e) => { this.setState({ country: e.target.value }) }} className="form-control" placeholder="Enter Country" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="itm">
                                    ...
                                    <div className="itm-cnt">
                                        <div className="form-group">
                                            ...
                                            <input type="number" id="text" value={this.state.zip_code} onChange={(e) => { this.setState({ zip_code: e.target.value }) }} className="form-control" placeholder="Enter Zip Code " list="zip" name="zip" />
                                            {/* <span className="material-icons">keyboard_arrow_down </span> */}
                                            <datalist id="zip">
                                                <option value="686541" />
                                            </datalist>
                                ...
                                <div className="itm">
                                    ...
                                    <div className="itm-cnt">
                                        <div className="form-group">
                                            ...
                                            <input type="text" id="text" value={this.state.comments} onChange={(e) => { this.setState({ comments: e.target.value }) }} className="form-control" placeholder="Enter Comments " />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="frm btn-sec">
                                <button className="btn btn-submit" onClick={() => { this.editBuilding() }}> <i className="material-icons tic"> check</i>Submit</button>
                            </div>
                        </div>
                    </div>
                </div>
