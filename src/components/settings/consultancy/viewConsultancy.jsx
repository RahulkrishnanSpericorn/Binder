                ...
                <div class="lst-bt-nav create">
                    <div class="table table-ara">
                                        ...
                                        <div class="row m-0">
                                            <div class="col-md-6 pl-0 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input disabled={true} type="text" id="text" value={this.state.name} onChange={(e) => { this.setState({ name: e.target.value, nameErrorMsg: false }) }} className="form-control" placeholder="Enter Consultancy Name" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 pl-0 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <input disabled={true} type="text" id="text" value={this.state.image_description} onChange={(e) => { this.setState({ image_description: e.target.value, nameErrorMsg: false }) }} className="form-control" placeholder="Enter Image Description" />
                                                </div>
                                            </div>
                        ...
                        <div className="frm btn-sec">
                            <button onClick={() => history.push('/consultancy')} className="btn btn-submit"> <i className="material-icons tic"> check</i>GO back</button>
                        </div>
...
export default connect(mapStateToProps, { ...actions })(viewConsultancy)
