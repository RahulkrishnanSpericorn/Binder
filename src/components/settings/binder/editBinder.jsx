   ...
   async componentDidMount() {
    ...
    editBinder = async () => {
        ...
        if (this.state.name != '' && this.state.consultancy_id != '' && this.state.client_id != '') {
            ...
            let id = this.state.binderId
            await this.props.editBinder(params,id)
            ToastMsg(this.props.binderReducer.editBinderData.message, 'info')
            if (this.props.binderReducer.editBinderData.message === "Binder updated successfully") {
                history.push('/binder')
            }
                    ...
                    <div className="pub-ara six">
                        ...
                        <div className="frm-ara three-col">
                                ...
                                <div className="itm">
                                    ...
                                    <div className="itm-cnt">
                                        <div className="form-group">
                                            ...
                                            <input type="text" id="text" value={this.state.name} onChange={(e) => { this.setState({ name: e.target.value, nameErrorMsg: false }) }} className="form-control" placeholder="Enter Binder Name" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="itm">
                                    ...
                                    <div className="itm-cnt">
                                        <div className="form-group">
                                            ...
                                            <input type="text" value={this.state.color} onChange={(e) => { this.setState({ color: e.target.value }) }} className="form-control" placeholder="Enter Color" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="itm">
                                    ...
                                    <div className="itm-cnt">
                                        <div className="form-group">
                                            ...
                                            <input type="text" value={this.state.text_color} onChange={(e) => { this.setState({ text_color: e.target.value }) }} className="form-control" placeholder="Enter Text Color" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="itm">
                                    ...
                                    <div className="itm-cnt">
                                        <div className="form-group">
                                            ...
                                            <input type="number" value={this.state.line} onChange={(e) => { this.setState({ line: e.target.value }) }} className="form-control" placeholder="Enter Line" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="itm">
                                    ...
                                    <div className="itm-cnt">
                                        <div className="form-group">
                                            ...
                                            <input type="number" value={this.state.order} onChange={(e) => { this.setState({ order: e.target.value }) }} className="form-control" placeholder="Enter Order" />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="frm btn-sec">
                                <button onClick={() => this.editBinder()} className="btn btn-submit"> <i className="material-icons tic"> check</i>Update</button>
                            </div>
                        </div>
