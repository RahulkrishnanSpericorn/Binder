...
class editRegion extends Component {
  ...
  async componentDidMount() {
    ...
    await this.setState({
      consultancyIdList: this.props.settingsCommonReducer
        .consultancyDropdownData.data,
  ...
  editRegion = async () => {
    ...
    if (
      ...
      // })
      if (
        this.props.regionReducer.editRegionData.message ===
                    ...
                    <div className="itm-cnt">
                      <div className="form-group select-group">
                        <label
                          className="form-control-placeholder"
                          style={{
                            color: this.state.consultancyErrorMsg && "red",
                          }}
                          for="f-name"
                        >
                          Consultancy *
...
export default connect(mapStateToProps, { ...actions, ...commonActions })(
  editRegion
);
